...
const styles = {
  ...
  actions:{display:"grid",gridTemplateColumns:"1fr",gap:"12px",marginBottom:"14px"},
  actionButton:{position:"relative",minWidth:0,height:"86px",padding:"16px 28px",borderRadius:"18px",color:"#fff",display:"flex",alignItems:"center",justifyContent:"flex-start",gap:"22px",textAlign:"left",fontSize:"20px",fontWeight:"900",boxShadow:"0 8px 24px rgba(0,0,0,.22)",cursor:"pointer"},
  ...
  actionIcon:{position:"static",width:"48px",height:"48px",flexShrink:0,borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",background:"#fff",fontSize:"27px",fontWeight:"900",boxShadow:"0 2px 10px rgba(0,0,0,.18)"},
